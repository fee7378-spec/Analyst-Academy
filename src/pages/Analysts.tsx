...
export const Analysts: React.FC = () => {
  ...
  const getAnalystErrorStats = (analyst: User) => {
    ...
    const errorsByTypeMap = analystErrors.reduce((acc: any, a: any) => {
    ...
    return { errorsByType, errorsByTag };
  };
            ...
            >
              ...
              <div className="p-6 max-h-[calc(100vh-120px)] overflow-y-auto">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                    <div className="p-4 bg-blue-50 dark:bg-blue-500/10 rounded-2xl border border-blue-100 dark:border-blue-500/20 flex items-center gap-4">
                      <div className="p-2 bg-blue-100 dark:bg-blue-500/20 rounded-xl text-blue-600 dark:text-blue-400">
                        <TrendingUp className="w-5 h-5" />
                      </div>
                      <div>
                        <p className="text-xs font-semibold text-blue-600 dark:text-blue-400 uppercase tracking-wider mb-0.5">Produtividade</p>
                        <p className="text-2xl font-bold text-blue-900 dark:text-blue-100">{getAnalystStats(selectedAnalyst).productivity}</p>
                      </div>
                    </div>
                    ...
                    <div className="h-64 w-full">
                      <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={getAnalystEvolution(selectedAnalyst, 'produtividade')} margin={{ top: 20, right: 5, left: 0, bottom: 0 }}>
                          ...
                          />
                          <Line name="Produtividade" type="monotone" dataKey="productivity" stroke="#3b82f6" strokeWidth={4} dot={false} />
                        </LineChart>
                      </ResponsiveContainer>
                    </div>
                  </div>
